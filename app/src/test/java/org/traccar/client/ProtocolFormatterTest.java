...
public class ProtocolFormatterTest {
    ...
    public void testFormatRequest() throws Exception {
        ...
        assertEquals("http://localhost:5055?id=123456789012345&timestamp=0&lat=0.0&lon=0.0&speed=0.0&bearing=0.0&altitude=0.0&accuracy=0.0&batteryLevel=0.0", url);
    }
    ...
    public void testFormatPathPortRequest() throws Exception {
        ...
        assertEquals("http://localhost:8888/path?id=123456789012345&timestamp=0&lat=0.0&lon=0.0&speed=0.0&bearing=0.0&altitude=0.0&accuracy=0.0&batteryLevel=0.0", url);
    }
    ...
    public void testFormatAlarmRequest() throws Exception {
        ...
        assertEquals("http://localhost:5055/path?id=123456789012345&timestamp=0&lat=0.0&lon=0.0&speed=0.0&bearing=0.0&altitude=0.0&accuracy=0.0&batteryLevel=0.0&alarm=alert%20message", url);
    }
}
