...
public class ProtocolFormatterTest {
    ...
    public void testFormatRequest() throws Exception {
        ...
        String url = ProtocolFormatter.formatRequest(RuntimeEnvironment.application, "http://localhost:5055", position);
    ...
    public void testFormatPathPortRequest() throws Exception {
        ...
        String url = ProtocolFormatter.formatRequest(RuntimeEnvironment.application, "http://localhost:8888/path", position);
    ...
    public void testFormatAlarmRequest() throws Exception {
        ...
        String url = ProtocolFormatter.formatRequest(RuntimeEnvironment.application, "http://localhost:5055/path", position, "alert message");
